...
@FileSystemInfo(type = "fstypegoeshere", // ([a-z0-9]+ only)
		description = "File system description goes here", factory = SwitchKernelFileSystem.MyFileSystemFactory.class)
public class SwitchKernelFileSystem implements GFileSystem {
	 ...
	 */
	public SwitchKernelFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + SwitchKernelFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryFull<SwitchKernelFileSystem>, GFileSystemProbeFull {

		@Override
		public SwitchKernelFileSystem create(FSRL containerFSRL, FSRLRoot targetFSRL,
				ByteProvider byteProvider, File containerFile, FileSystemService fsService,
				TaskMonitor monitor) throws IOException, CancelledException {

			SwitchKernelFileSystem fs = new SwitchKernelFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
