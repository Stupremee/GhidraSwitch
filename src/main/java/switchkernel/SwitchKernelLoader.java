...
public class SwitchKernelLoader extends AbstractLibrarySupportLoader {
	public static final String NAME = "HorizonOS Loader";
	...
	public Collection<LoadSpec> findSupportedLoadSpecs(ByteProvider provider) throws IOException {
		...
		LoadSpec loadSpec = new LoadSpec(this, 0,
				new LanguageCompilerSpecPair(AARCH64_LANGUAGE_ID, new CompilerSpecID("default")), true);
